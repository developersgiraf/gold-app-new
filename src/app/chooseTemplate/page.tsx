...
export default function TemplateChoosen() {
  ...
  return (
    <LayoutWrapper title="Choose Your Template">
      {({ toggleSidebar, title }) => (
        <div className="flex justify-center">
          <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl h-screen bg-[#093D39] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6">
              ...
              <h2 className="text-xl font-bold text-white">Create Your Own Template</h2>
              <p className="text-white/70 text-sm mt-1 mb-6">Select a design for your daily gold rate poster</p>
              ...
              <div className="grid grid-cols-1 gap-6">
                {templates.map(template => (
                  <div key={template.id} className="w-full">
                    ...
                    {/* Use Template Button */}
                    <Button 
                      className="w-full mt-3 !bg-gradient-to-r from-[#FB9600] to-[#E27300] !text-white py-3 rounded-xl font-semibold"
